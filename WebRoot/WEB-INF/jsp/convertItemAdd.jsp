...
<script type="text/javascript" src="${path }js/schedule.js"></script>
<link rel="stylesheet" type="text/css"
	href="${path }css/bootstrap-switch.css" />
<link rel="stylesheet" type="text/css"
			...
			<div class="panel panel-default col-md-12">
				<div class="panel-heading">
					<h4 class="panel-title">
						<i class="fa fa-map-marker"></i>&nbsp;&nbsp;兑换记录录入
					</h4>
				</div>

				<div id="collapseThree" class="panel-collapse collapse in">
					<div class="panel-body">
						<form action="convert_add" method="post" class="form">
							...
							<div class="panel panel-default details">
								...
								<table class="table">
									...
									<tr>
										<td><input type="text" value="" name="form.commodity"
											class="form-control" /></td>
										<td><input type="text" value="" class="form-control" /></td>
										<td><input type="text" value="" class="form-control" /></td>
										<td><input type="text" value="" name="form.amount"
											class="form-control" /></td>
										<td><input type="text" value="" class="form-control" /></td>
									</tr>
									<tr>
